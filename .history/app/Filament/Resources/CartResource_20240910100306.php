        ...
        ->bulkActions([
            ...
            Tables\Actions\BulkAction::make('buy')
                ...
                ->action(function ($records) {
                    $recordIds = $records->pluck('id')->toArray(); // Ambil ID dari records
                    // Lakukan redirect langsung ke route checkout dengan data produk yang dipilih
                    return redirect()->route('checkout', ['selected_products' => $recordIds]);
                })
                ->color('success'),
        ])
