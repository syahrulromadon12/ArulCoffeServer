...
Route::middleware(['web', CorsMiddleware::class])
    ->group(function () {
        ...
        Route::middleware(['auth'])->group(function () {
            ...
            Route::post('/checkout/SQLSTATE[23000]: Integrity constraint violation: 19 NOT NULL constraint failed: carts.product_id (Connection: sqlite, SQL: insert into "carts" ("user_id", "product_id", "quantity", "updated_at", "created_at") values (1, ?, 1, 2024-09-14 04:25:50, 2024-09-14 04:25:50))', [CheckoutController::class, 'processPayment'])->name('checkout.process');              
